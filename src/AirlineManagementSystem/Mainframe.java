...
public class Mainframe extends JFrame{
    ...
    private void initialize() {
        ...
        NewLabel.setIcon(new ImageIcon(ClassLoader.getSystemResource("AirlineManagementSystem/icon/front.jpg")));NewLabel.setBounds(0, 0, 1850,700 );
        add(NewLabel);

        JLabel AirlineManagementSystem = new JLabel("NEPAL AIRLINES  WELCOMES YOU");
        AirlineManagementSystem.setForeground(Color.BLUE);
        AirlineManagementSystem.setFont(new Font("Tahoma", Font.BOLD, 36));
        AirlineManagementSystem.setBounds(300, 20, 5000, 55);
